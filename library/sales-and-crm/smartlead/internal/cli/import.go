...
but do not stop the import.`,
  ...
  smartlead-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  smartlead-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | smartlead-pp-cli import <resource> --input -`,
