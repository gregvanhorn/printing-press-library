...
Exit codes & warnings:
  ...
  smartlead-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  smartlead-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  smartlead-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  smartlead-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  smartlead-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "campaigns_analytics":
		return db.UpsertCampaignsAnalytics(data)
	case "create_subsequence":
		return db.UpsertCreateSubsequence(data)
	case "campaigns_email_accounts":
		return db.UpsertCampaignsEmailAccounts(data)
	case "export":
		return db.UpsertExport(data)
	case "campaigns_leads":
		return db.UpsertCampaignsLeads(data)
	case "leads_export":
		return db.UpsertLeadsExport(data)
	case "leads_statistics":
		return db.UpsertLeadsStatistics(data)
	case "reply_email_thread":
		return db.UpsertReplyEmailThread(data)
	case "schedule":
		return db.UpsertSchedule(data)
	case "send_test_email":
		return db.UpsertSendTestEmail(data)
	case "sequence_analytics":
		return db.UpsertSequenceAnalytics(data)
	case "sequences":
		return db.UpsertSequences(data)
	case "settings":
		return db.UpsertSettings(data)
	case "campaigns_smart_senders":
		return db.UpsertCampaignsSmartSenders(data)
	case "statistics":
		return db.UpsertStatistics(data)
	case "campaigns_status":
		return db.UpsertCampaignsStatus(data)
	case "campaigns_webhooks":
		return db.UpsertCampaignsWebhooks(data)
	case "client":
		return db.UpsertClient(data)
	case "crm":
		return db.UpsertCrm(data)
	case "email_accounts":
		return db.UpsertEmailAccounts(data)
	case "health_metrics":
		return db.UpsertHealthMetrics(data)
	case "sending_limits":
		return db.UpsertSendingLimits(data)
	case "tag":
		return db.UpsertTag(data)
	case "test_connection":
		return db.UpsertTestConnection(data)
	case "warmup":
		return db.UpsertWarmup(data)
	case "warmup_settings":
		return db.UpsertWarmupSettings(data)
	case "warmup_stats":
		return db.UpsertWarmupStats(data)
	case "warmup_status":
		return db.UpsertWarmupStatus(data)
	case "import":
		return db.UpsertImport(data)
	case "leads":
		return db.UpsertLeads(data)
	case "leads_campaigns":
		return db.UpsertLeadsCampaigns(data)
	case "unsubscribe":
		return db.UpsertUnsubscribe(data)
	case "unsubscribe_all":
		return db.UpsertUnsubscribeAll(data)
	case "master_inbox":
		return db.UpsertMasterInbox(data)
	case "pause":
		return db.UpsertPause(data)
	case "reset_reputation":
		return db.UpsertResetReputation(data)
	case "resume":
		return db.UpsertResume(data)
	case "spam_test":
		return db.UpsertSpamTest(data)
	case "blacklists":
		return db.UpsertBlacklists(data)
	case "dkim_details":
		return db.UpsertDkimDetails(data)
	case "domain_blacklist":
		return db.UpsertDomainBlacklist(data)
	case "email_content":
		return db.UpsertEmailContent(data)
	case "email_headers":
		return db.UpsertEmailHeaders(data)
	case "ip_blacklist_count":
		return db.UpsertIpBlacklistCount(data)
	case "ip_details":
		return db.UpsertIpDetails(data)
	case "mailbox_count":
		return db.UpsertMailboxCount(data)
	case "mailbox_summary":
		return db.UpsertMailboxSummary(data)
	case "rdns_report":
		return db.UpsertRdnsReport(data)
	case "schedule_history":
		return db.UpsertScheduleHistory(data)
	case "sender_account_list":
		return db.UpsertSenderAccountList(data)
	case "spam_filter_report":
		return db.UpsertSpamFilterReport(data)
	case "spf_details":
		return db.UpsertSpfDetails(data)
	case "stop":
		return db.UpsertStop(data)
	case "webhooks":
		return db.UpsertWebhooks(data)
	case "webhooks_analytics":
		return db.UpsertWebhooksAnalytics(data)
	case "delivery_logs":
		return db.UpsertDeliveryLogs(data)
	case "events":
		return db.UpsertEvents(data)
	case "webhooks_status":
		return db.UpsertWebhooksStatus(data)
	case "test":
...
func defaultSyncResources() []string {
	return []string{
		...
		"leads",
		"leads-categories",
		"leads-global-blocklist",
		"smart-senders",
		"smart-senders-vendors",
		"smartlead-analytics",
		"smartlead-analytics-day-wise-overall-stats",
		"smartlead-analytics-overall-stats",
		"smartlead-analytics-overall-stats-v2",
		"smartlead-analytics-provider-wise-overall-performance",
		"spam-test",
		"spam-test-folder",
		"spam-test-seed-providers",
		"webhooks",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"campaigns": "/campaigns/",
		"campaigns-all-leads-activities": "/campaigns/all-leads-activities",
		"campaigns-analytics": "/campaigns/analytics",
		"client": "/client/",
		"client-api-key": "/client/api-key",
		"crm": "/crm/tags",
		"crm-leads-tags": "/crm/leads/tags",
		"email-accounts": "/email-accounts",
		"lead-list": "/lead-list/",
		"leads": "/leads",
		"leads-categories": "/leads/categories",
		"leads-global-blocklist": "/leads/global-blocklist",
		"smart-senders": "/smart-senders/domains",
		"smart-senders-vendors": "/smart-senders/vendors",
		"smartlead-analytics": "/analytics/client/list",
		"smartlead-analytics-day-wise-overall-stats": "/analytics/day-wise-overall-stats",
		"smartlead-analytics-overall-stats": "/analytics/lead/overall-stats",
		"smartlead-analytics-overall-stats-v2": "/analytics/overall-stats-v2",
		"smartlead-analytics-provider-wise-overall-performance": "/analytics/mailbox/provider-wise-overall-performance",
		"spam-test": "/spam-test/list",
		"spam-test-folder": "/spam-test/folder",
		"spam-test-seed-providers": "/spam-test/seed/providers",
		"webhooks": "/webhooks",
		"webhooks-event-types": "/webhooks/event-types",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "campaigns_leads", ParentTable: "campaigns", ParentIDParam: "id", PathTemplate: "/campaigns/{id}/leads"},
		{Name: "events", ParentTable: "webhooks", ParentIDParam: "id", PathTemplate: "/webhooks/{id}/events"},
		{Name: "leads_statistics", ParentTable: "campaigns", ParentIDParam: "id", PathTemplate: "/campaigns/{id}/leads-statistics"},
	}
}
