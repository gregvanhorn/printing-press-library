...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  smartlead-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  smartlead-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"campaigns", "campaigns-all-leads-activities", "campaigns-analytics", "client", "client-api-key", "crm", "crm-leads-tags", "email-accounts", "lead-list", "leads", "leads-categories", "leads-global-blocklist", "smart-senders", "smart-senders-vendors", "smartlead-analytics", "smartlead-analytics-day-wise-overall-stats", "smartlead-analytics-overall-stats", "smartlead-analytics-overall-stats-v2", "smartlead-analytics-provider-wise-overall-performance", "spam-test", "spam-test-folder", "spam-test-seed-providers", "webhooks", "webhooks-event-types",  }
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  smartlead-pp-cli workflow status

  # Show status as JSON
  smartlead-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("smartlead-pp-cli")
			}
