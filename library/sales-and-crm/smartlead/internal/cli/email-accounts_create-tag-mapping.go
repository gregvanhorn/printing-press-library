...
func newEmailAccountsCreateTagMappingCmd(flags *rootFlags) *cobra.Command {
	var bodyEmails string
	var bodyTagIds string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:   "create-tag-mapping",
		Short: "Map tags to emails",
		Example: "  smartlead-pp-cli email-accounts create-tag-mapping",
		Annotations: map[string]string{"pp:endpoint": "email-accounts.create-tag-mapping", "pp:method": "POST", "pp:path": "/email-accounts/tag-mapping"},
