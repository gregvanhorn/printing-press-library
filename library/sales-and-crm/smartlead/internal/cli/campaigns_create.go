...
func newCampaignsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  smartlead-pp-cli campaigns create --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "campaigns.create", "pp:method": "POST", "pp:path": "/campaigns/create"},
