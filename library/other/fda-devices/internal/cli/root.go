...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "fda-devices-pp-cli",
		Short: `Fda Devices CLI — Regulatory intelligence for FDA medical devices — predicate-chain auditing, competitive scanning, and safety pattern de…`,
		Long: `Fda Devices CLI — Regulatory intelligence for FDA medical devices — predicate-chain auditing, competitive scanning, and safety pattern de…
...
Health check: run 'fda-devices-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("fda-devices-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'fda-devices-pp-cli profile list')")
	...
	devCmd := newDeviceCmd(flags)
	devCmd.Hidden = true
	rootCmd.AddCommand(devCmd)
	rootCmd.AddCommand(new510kCmd(flags))
	rootCmd.AddCommand(newPMACmd(flags))
	rootCmd.AddCommand(newRecallCmd(flags))
	rootCmd.AddCommand(newMaudeCmd(flags))
	rootCmd.AddCommand(newClassificationCmd(flags, "classification"))
	rootCmd.AddCommand(newClassificationCmd(flags, "product-code"))
	rootCmd.AddCommand(newEstablishmentCmd(flags))
	rootCmd.AddCommand(newApplicantCmd(flags))
	rootCmd.AddCommand(newCompetitorsCmd(flags))
	rootCmd.AddCommand(newPredicateChainCmd(flags))
	rootCmd.AddCommand(newApplicantHistoryRootCmd(flags))
	rootCmd.AddCommand(newRecallLinkCmd(flags))
	rootCmd.AddCommand(newMarketEntryCmd(flags))
	rootCmd.AddCommand(newSafetyPatternCmd(flags))
	rootCmd.AddCommand(newStoryCmd(flags))
	rootCmd.AddCommand(newWatchCmd(flags))
	rootCmd.AddCommand(newSQLCmd(flags))
	rootCmd.AddCommand(newCrossSearchCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("fda-devices-pp-cli %s\n", version)
		},
	}
}
