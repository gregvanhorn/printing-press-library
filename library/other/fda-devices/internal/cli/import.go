...
but do not stop the import.`,
  ...
  fda-devices-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  fda-devices-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | fda-devices-pp-cli import <resource> --input -`,
