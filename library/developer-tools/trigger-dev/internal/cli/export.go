...
large datasets as it has no memory pressure.`,
  ...
  trigger-dev-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  trigger-dev-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  trigger-dev-pp-cli export <resource> --format jsonl | jq '.id'`,
