...
func Execute() error {
	...
	rootCmd := &cobra.Command{
		Use:           "trigger-dev-pp-cli",
		Short:         "Monitor runs, trigger tasks, manage schedules, and detect failures via the Trigger.dev API",
		SilenceUsage:  true,
		SilenceErrors: true,
		Version:       version,
	}
	rootCmd.SetVersionTemplate("trigger-dev-pp-cli {{ .Version }}\n")
	...
	rootCmd.AddCommand(newRunsPromotedCmd(&flags))
	rootCmd.AddCommand(newSchedulesPromotedCmd(&flags))
	rootCmd.AddCommand(newQueuesPromotedCmd(&flags))
	rootCmd.AddCommand(newBatchesPromotedCmd(&flags))
	rootCmd.AddCommand(newEnvvarsPromotedCmd(&flags))
	rootCmd.AddCommand(newDeploymentsPromotedCmd(&flags))
	rootCmd.AddCommand(newWaitpointsPromotedCmd(&flags))
	rootCmd.AddCommand(newWatchCmd(&flags))
	rootCmd.AddCommand(newFailuresCmd(&flags))
	rootCmd.AddCommand(newHealthCmd(&flags))
	rootCmd.AddCommand(newCostsCmd(&flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("trigger-dev-pp-cli %s\n", version)
		},
	}
}
