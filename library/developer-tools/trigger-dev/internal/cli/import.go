...
but do not stop the import.`,
  ...
  trigger-dev-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  trigger-dev-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | trigger-dev-pp-cli import <resource> --input -`,
