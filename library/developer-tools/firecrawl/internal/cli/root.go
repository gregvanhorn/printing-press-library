...
func Execute() error {
	...
	rootCmd := &cobra.Command{
		Use:   "firecrawl-pp-cli",
		Short: "Manage firecrawl resources via the firecrawl API",
		Long: `Manage firecrawl resources via the firecrawl API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'firecrawl-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("firecrawl-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'firecrawl-pp-cli profile list')")
	...
	rootCmd.AddCommand(newDeepResearchCmd(&flags))
	rootCmd.AddCommand(newExtractCmd(&flags))
	rootCmd.AddCommand(newLlmstxtCmd(&flags))
	...
	rootCmd.AddCommand(newMapPromotedCmd(&flags))
	rootCmd.AddCommand(newScrapePromotedCmd(&flags))
