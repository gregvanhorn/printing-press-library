...
func RegisterTools(s *server.MCPServer) {
	...
	s.AddTool(
		mcplib.NewTool("pypi_json_get-package-version-info",
			mcplib.WithDescription("Get package info for a specific version Returns PackageResponse."),
...
func handleSync(ctx context.Context, req mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	return mcplib.NewToolResultText("sync not yet implemented via MCP - use the CLI: pypi-pp-cli sync"), nil
}
