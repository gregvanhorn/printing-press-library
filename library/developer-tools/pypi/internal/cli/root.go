...
func Execute() error {
	...
	rootCmd := &cobra.Command{
		Use:   "pypi-pp-cli",
		Short: "Manage pypi resources via the pypi API",
		Long: `Manage pypi resources via the pypi API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'pypi-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pypi-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pypi-pp-cli profile list')")
