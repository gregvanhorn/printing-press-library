...
but do not stop the import.`,
  ...
  company-goat-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  company-goat-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | company-goat-pp-cli import <resource> --input -`,
