...
func newFilingsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagCik string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(c, flags, "filings", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagCik, "cik", "", "10-digit zero-padded SEC Central Index Key (e.g., 0001318605 for Tesla)")
