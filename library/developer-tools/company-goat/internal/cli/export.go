...
large datasets as it has no memory pressure.`,
  ...
  company-goat-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  company-goat-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  company-goat-pp-cli export <resource> --format jsonl | jq '.id'`,
