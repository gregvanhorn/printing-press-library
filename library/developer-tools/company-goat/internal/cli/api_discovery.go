...
Run 'api <interface>' to see that interface's methods.`,
  ...
  company-goat-pp-cli api

  # Show methods for a specific interface
  company-goat-pp-cli api <interface-name>`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if len(args) > 0 {
				...
				return fmt.Errorf("interface %q not found. Run '%s-pp-cli api' to list all interfaces", args[0], "company")
			}
