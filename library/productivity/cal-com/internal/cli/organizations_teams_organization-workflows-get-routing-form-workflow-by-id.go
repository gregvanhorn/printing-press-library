...
func newOrganizationsTeamsOrganizationWorkflowsGetRoutingFormWorkflowByIdCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:     "organization-workflows-get-routing-form-workflow-by-id <teamId> <workflowId> <orgId>",
		Short:   "Get organization team workflow",
		Example: "  cal-com-pp-cli organizations teams organization-workflows-get-routing-form-workflow-by-id 42 42 42",
