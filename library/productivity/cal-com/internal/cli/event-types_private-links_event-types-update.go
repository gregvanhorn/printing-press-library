...
func newEventTypesPrivateLinksEventTypesUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyExpiresAt, "expires-at", "", "New expiration date for time-based links")
	cmd.Flags().Float64Var(&bodyMaxUsageCount, "max-usage-count", 0.0, "New maximum number of times the link can be used")
