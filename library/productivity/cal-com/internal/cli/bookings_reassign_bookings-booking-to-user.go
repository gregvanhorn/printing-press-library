...
func newBookingsReassignBookingsBookingToUserCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyReason, "reason", "", "Reason for reassigning the booking")
