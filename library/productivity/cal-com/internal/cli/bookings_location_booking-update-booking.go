...
func newBookingsLocationBookingUpdateBookingCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyLocation, "location", "", "One of the event type locations. If instead of passing one of the location objects as required by schema you are...")
