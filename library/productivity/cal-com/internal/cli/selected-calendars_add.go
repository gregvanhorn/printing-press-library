...
func newSelectedCalendarsAddCmd(flags *rootFlags) *cobra.Command {
	var bodyCredentialId float64
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if stdinBody {
				...
				body = map[string]any{}
				if bodyCredentialId != 0.0 {
					body["credentialId"] = bodyCredentialId
				}
	...
	cmd.Flags().Float64Var(&bodyCredentialId, "credential-id", 0.0, "Credential id")
	...
	cmd.Flags().StringVar(&bodyIntegration, "integration", "", "Integration")
