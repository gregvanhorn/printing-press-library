...
func newOrganizationsAttributesOrganizationsOptionsAssignOrganizationOptionToUserCmd(flags *rootFlags) *cobra.Command {
	var bodyAttributeId string
	var bodyAttributeOptionId string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				if !cmd.Flags().Changed("attribute-id") && !flags.dryRun {
					return fmt.Errorf("required flag \"%s\" not set", "attribute-id")
				}
			}
			...
			if stdinBody {
				...
				body = map[string]any{}
				if bodyAttributeId != "" {
					body["attributeId"] = bodyAttributeId
				}
				if bodyAttributeOptionId != "" {
					body["attributeOptionId"] = bodyAttributeOptionId
				}
				if bodyValue != "" {
	...
	cmd.Flags().StringVar(&bodyAttributeId, "attribute-id", "", "Attribute id")
	cmd.Flags().StringVar(&bodyAttributeOptionId, "attribute-option-id", "", "Attribute option id")
