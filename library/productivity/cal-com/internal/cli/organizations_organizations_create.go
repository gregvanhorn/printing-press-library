...
func newOrganizationsOrganizationsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:     "create <orgId>",
		Short:   "Create an organization within an organization",
	...
	cmd.Flags().StringVar(&bodyName, "name", "", "Name of the organization")
	cmd.Flags().StringVar(&bodySlug, "slug", "", "Organization slug in kebab-case - if not provided will be generated automatically based on name.")
