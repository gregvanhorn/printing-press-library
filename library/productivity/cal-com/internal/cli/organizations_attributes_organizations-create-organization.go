...
func newOrganizationsAttributesOrganizationsCreateOrganizationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  cal-com-pp-cli organizations attributes organizations-create-organization 42 --name example-resource",
