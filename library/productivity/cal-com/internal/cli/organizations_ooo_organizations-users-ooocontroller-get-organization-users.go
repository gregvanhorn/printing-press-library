...
func newOrganizationsOooOrganizationsUsersOoocontrollerGetOrganizationUsersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(c, flags, "ooo", false, path, params)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagEmail, "email", "", "Filter ooo entries by the user email address. user must be within your organization.")
