...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  roam-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  roam-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"addr-info", "chat-list", "group-members", "groups", "groups-list", "lobby-list", "magicast-list", "meeting-list", "onair-event-list", "recording-list", "resource-types", "schemas", "token-info", "transcript-list", "user-list", "userauditlog-list", "users",  }
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  roam-pp-cli workflow status

  # Show status as JSON
  roam-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("roam-pp-cli")
			}
