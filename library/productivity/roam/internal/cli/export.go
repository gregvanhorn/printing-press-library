...
large datasets as it has no memory pressure.`,
  ...
  roam-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  roam-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  roam-pp-cli export <resource> --format jsonl | jq '.id'`,
