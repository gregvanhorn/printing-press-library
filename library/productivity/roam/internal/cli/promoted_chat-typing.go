...
func newChatTypingPromotedCmd(flags *rootFlags) *cobra.Command {
	var bodyChat string
	...
	cmd.Flags().IntVar(&bodyThreadTimestamp, "thread-timestamp", 0, "Timestamp of the message being replied to.")
