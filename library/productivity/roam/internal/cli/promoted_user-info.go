...
func newUserInfoPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "user-info", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flagId, "id", "", "The User ID to look up.")
	cmd.Flags().StringVar(&flagExpand, "expand", "", "Comma-separated list of additional fields to include in the response. Supported values&#58; `status`, `available`...")
