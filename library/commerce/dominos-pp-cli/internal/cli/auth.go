	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if header == "" {
				...
				fmt.Fprintln(w, "  export DOMINOS_TOKEN=\"your-token-here\"")
				fmt.Fprintf(w, "  dominos-pp-cli auth set-token <token>\n")
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if os.Getenv("DOMINOS_TOKEN") != "" {
				fmt.Fprintf(cmd.OutOrStdout(), "Config cleared. Note: DOMINOS_TOKEN env var is still set.\n")
				return nil
			}
