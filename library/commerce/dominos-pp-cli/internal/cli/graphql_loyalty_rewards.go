...
func newGraphqlLoyaltyRewardsCmd(flags *rootFlags) *cobra.Command {
	var bodyOperationName string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:     "loyalty_rewards",
		Short:   "Get available loyalty rewards by tier",
		Example: "  dominos-pp-cli graphql loyalty_rewards --operationName LoyaltyRewards",
