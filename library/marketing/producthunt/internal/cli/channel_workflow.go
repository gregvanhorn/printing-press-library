...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  producthunt-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  producthunt-pp-cli workflow archive --full`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/producthunt-pp-cli/data.db)")
