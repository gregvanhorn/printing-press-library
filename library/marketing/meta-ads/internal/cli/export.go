...
large datasets as it has no memory pressure.`,
  ...
  meta-ads-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  meta-ads-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  meta-ads-pp-cli export <resource> --format jsonl | jq '.id'`,
