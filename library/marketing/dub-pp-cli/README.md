...
```
brew install trevin-chow/tap/dub-pp-cli
```
...
- [**dubco**](https://github.com/sujjeee/dubco) — TypeScript
- [**dubco-mcp-server**](https://github.com/Gitmaxd/dubco-mcp-server-npm) — TypeScript
- [**dub-go**](https://github.com/dubinc/dub-go) — Go
- [**dub (TypeScript SDK)**](https://github.com/dubinc/dub-ts) — TypeScript
- [**dub-python**](https://github.com/dubinc/dub-python) — Python
