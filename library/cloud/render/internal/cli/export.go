...
large datasets as it has no memory pressure.`,
  ...
  render-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  render-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  render-pp-cli export <resource> --format jsonl | jq '.id'`,
