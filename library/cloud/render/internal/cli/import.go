...
but do not stop the import.`,
  ...
  render-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  render-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | render-pp-cli import <resource> --input -`,
