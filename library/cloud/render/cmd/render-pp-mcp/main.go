...
import (
	...
	mcptools "github.com/mvanhorn/printing-press-library/library/cloud/render/internal/mcp"
)
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "render-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
