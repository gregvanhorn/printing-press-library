...
func newIsteamUserStatsGetSchemaForGameCmd(flags *rootFlags) *cobra.Command {
	var flagKey string
	var flagAppid string
	var flagL string

	cmd := &cobra.Command{
		Use:   "get-schema-for-game",
		Short: "GetSchemaForGame operation of ISteamUserStats",
		Example: "  steam-web-pp-cli isteam-user-stats get-schema-for-game",
