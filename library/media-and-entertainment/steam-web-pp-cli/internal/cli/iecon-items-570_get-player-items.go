...
func newIeconItems570GetPlayerItemsCmd(flags *rootFlags) *cobra.Command {
	var flagSteamid string

	cmd := &cobra.Command{
		Use:     "get-player-items",
		Aliases: []string{"list"},
		Short:   "GetPlayerItems operation of IEconItems_570",
		Example: "  steam-web-pp-cli iecon-items-570 get-player-items",
