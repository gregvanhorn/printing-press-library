...
func newIeconItems730GetPlayerItemsCmd(flags *rootFlags) *cobra.Command {
	var flagSteamid string

	cmd := &cobra.Command{
		Use:     "get-player-items",
		Aliases: []string{"list"},
		Short:   "GetPlayerItems operation of IEconItems_730",
		Example: "  steam-web-pp-cli iecon-items-730 get-player-items",
