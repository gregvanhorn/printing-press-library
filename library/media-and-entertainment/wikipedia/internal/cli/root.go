...
func Execute() error {
	...
	rootCmd := &cobra.Command{
		Use:   "wikipedia-pp-cli",
		Short: "Manage wikipedia resources via the wikipedia API",
		Long: `Manage wikipedia resources via the wikipedia API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'wikipedia-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("wikipedia-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'wikipedia-pp-cli profile list')")
