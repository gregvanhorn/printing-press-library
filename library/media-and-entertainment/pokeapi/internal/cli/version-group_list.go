...
func newVersionGroupListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		...
		Example: "  pokeapi-pp-cli version-group list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(c, flags, "version-group", path, map[string]string{
