...
func newPokedexListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List pokedex",
		Example: "  pokeapi-pp-cli pokedex list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/pokedex/"
			data, prov, err := resolvePaginatedRead(c, flags, "pokedex", path, map[string]string{
