...
func newNatureListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List natures",
		Example: "  pokeapi-pp-cli nature list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/nature/"
			data, prov, err := resolvePaginatedRead(c, flags, "nature", path, map[string]string{
