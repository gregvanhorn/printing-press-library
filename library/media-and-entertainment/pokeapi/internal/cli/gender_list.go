...
func newGenderListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List genders",
		Example: "  pokeapi-pp-cli gender list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/gender/"
			data, prov, err := resolvePaginatedRead(c, flags, "gender", path, map[string]string{
