...
In local mode: searches locally synced data only.`,
  ...
  pokeapi-pp-cli search "error timeout"

  # Force local search only
  pokeapi-pp-cli search "payment failed" --data-source local

  # Search a specific resource type locally
  pokeapi-pp-cli search "critical" --type transactions --data-source local

  # JSON output for piping
  pokeapi-pp-cli search "critical" --json --limit 20`,
