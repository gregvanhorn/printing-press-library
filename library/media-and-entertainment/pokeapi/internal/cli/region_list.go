...
func newRegionListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List regions",
		Example: "  pokeapi-pp-cli region list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/region/"
			data, prov, err := resolvePaginatedRead(c, flags, "region", path, map[string]string{
