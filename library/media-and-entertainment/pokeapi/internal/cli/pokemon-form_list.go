...
func newPokemonFormListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List pokemon forms",
		Example: "  pokeapi-pp-cli pokemon-form list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(c, flags, "pokemon-form", path, map[string]string{
