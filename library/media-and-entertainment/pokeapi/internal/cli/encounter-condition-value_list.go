...
func newEncounterConditionValueListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List encounter condition values",
		Example: "  pokeapi-pp-cli encounter-condition-value list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(c, flags, "encounter-condition-value", path, map[string]string{
