...
func newPokeathlonStatListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List pokeathlon stats",
		Example: "  pokeapi-pp-cli pokeathlon-stat list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(c, flags, "pokeathlon-stat", path, map[string]string{
