...
func newPokemonShapeListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List pokemon shapes",
		Example: "  pokeapi-pp-cli pokemon-shape list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedRead(c, flags, "pokemon-shape", path, map[string]string{
