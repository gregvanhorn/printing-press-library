...
func newStatListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List stats",
		Example: "  pokeapi-pp-cli stat list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/stat/"
			data, prov, err := resolvePaginatedRead(c, flags, "stat", path, map[string]string{
