...
func newMoveListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List moves",
		Example: "  pokeapi-pp-cli move list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/move/"
			data, prov, err := resolvePaginatedRead(c, flags, "move", path, map[string]string{
