...
func newBerryListCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	var flagOffset int
	var flagQ string
	var flagAll bool
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "List berries",
		Example: "  pokeapi-pp-cli berry list",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v2/berry/"
			data, prov, err := resolvePaginatedRead(c, flags, "berry", path, map[string]string{
