...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "whoop-pp-cli",
		Short: "Manage whoop resources via the whoop API",
		Long: `Manage whoop resources via the whoop API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'whoop-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("whoop-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'whoop-pp-cli profile list')")
	...
	rootCmd.AddCommand(newCycleCmd(flags))
	...
	rootCmd.AddCommand(newActivityMappingPromotedCmd(flags))
	rootCmd.AddCommand(newRecoveryPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())
	rootCmd.AddCommand(newTrendCmd(flags))
	rootCmd.AddCommand(newDigestCmd(flags))
	rootCmd.AddCommand(newClassifyCmd(flags))
	rootCmd.AddCommand(newCorrelateCmd(flags))
	rootCmd.AddCommand(newSleepDebtCmd(flags))
	rootCmd.AddCommand(newStrainBudgetCmd(flags))
